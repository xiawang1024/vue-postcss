...
const shareLink = `${baseUrl}/signUp/20180918/signIn/index.html`
const shareTitle = '签到入场'
const shareDesc = '2018年广播融媒体技术专业委员会年会'
// const shareImg = require('../common/imgs/logo.png');
const shareImg = `${baseUrl}/signUp/20180918/logo.png`
